module {
  firrtl.circuit "Bundle" {
    ...
    firrtl.module private @Probe(in %in: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %r: !firrtl.openbundle<a: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, b: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>>, out %mixed: !firrtl.openbundle<a: uint<1>, x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>, b: vector<uint<1>, 2>>, out %nohw: !firrtl.openbundle<x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>>, 2>>) {
      ...
      %5 = firrtl.opensubfield %mixed[x] : !firrtl.openbundle<a: uint<1>, x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>, b: vector<uint<1>, 2>>
      %6 = firrtl.opensubindex %5[1] : !firrtl.openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>
      %7 = firrtl.opensubfield %6[data] : !firrtl.openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>
      %8 = firrtl.opensubfield %6[p] : !firrtl.openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>
      %9 = firrtl.opensubindex %5[0] : !firrtl.openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>
      %10 = firrtl.opensubfield %9[data] : !firrtl.openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>
      %11 = firrtl.opensubfield %9[p] : !firrtl.openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>
      %12 = firrtl.opensubfield %mixed[b] : !firrtl.openbundle<a: uint<1>, x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>, b: vector<uint<1>, 2>>
      %13 = firrtl.opensubfield %mixed[a] : !firrtl.openbundle<a: uint<1>, x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>, b: vector<uint<1>, 2>>
    ...
    firrtl.module @Bundle(in %in: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %out1: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %out2: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %out3: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %out4: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %out5: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %out6: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out %out7: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>) attributes {convention = #firrtl<convention scalarized>} {
      ...
      %p_in, %p_r, %p_mixed, %p_nohw = firrtl.instance p interesting_name @Probe(in in: !firrtl.bundle<a: uint<1>, b: vector<uint<1>, 2>>, out r: !firrtl.openbundle<a: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, b: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>>, out mixed: !firrtl.openbundle<a: uint<1>, x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>, b: vector<uint<1>, 2>>, out nohw: !firrtl.openbundle<x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>>, 2>>)
      ...
      %9 = firrtl.opensubfield %p_mixed[x] : !firrtl.openbundle<a: uint<1>, x: openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>, b: vector<uint<1>, 2>>
      %10 = firrtl.opensubindex %9[1] : !firrtl.openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>
      %11 = firrtl.opensubfield %10[p] : !firrtl.openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>
      %12 = firrtl.opensubindex %9[0] : !firrtl.openvector<openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>, 2>
      %13 = firrtl.opensubfield %12[p] : !firrtl.openbundle<p: probe<bundle<a: uint<1>, b: vector<uint<1>, 2>>>, data: uint<1>>
